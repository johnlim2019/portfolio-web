            ...
            <Container className="responsiveContainer">
                <Center>
                    <Stack ta="center" className={aboutStyles.stackContainer}>
                        ...
                        <List>
                            <List.Item>I am working with the Wefaa Robotics team to develop the Smorphi Imaginary Learning Platform. A 3D robot simulator built with Unity to expose children to coding and robotics</List.Item>
