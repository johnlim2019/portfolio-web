        ...
        <>
            ...
            <Container className="responsiveContainer">
                <Stack align="center">
                    ...
                    <RecentPostDisplay title="Projects" jsonFile="./featured_projects.json" slugPrefix="projects" />
                    <Center p='lg'>
                        <Divider orientation="vertical" color="white" h='5em'></Divider>
                    </Center>
                    <Center>
                    ...
                    <RecentPostDisplay title="Writings" jsonFile="./featured_writings.json" slugPrefix="writings" />
                </Stack>
            </Container >
